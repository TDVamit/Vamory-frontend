...
export const AISearchToggle = ({ isEnabled, onToggle, className = '' }: AISearchToggleProps) => {
  return (
    <button
      ...
      className={`flex items-center justify-center gap-2 px-3 py-2 rounded-lg transition-all duration-200 h-full min-h-[44px] ${
        isEnabled
    ...
    >
      <Sparkles className={`w-4 h-4 ${isEnabled ? 'text-white' : 'text-gray-400'}`} />
